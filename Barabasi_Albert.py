    ...
    for i in range (noeuds) :
        ...
        while k<nombreAretesRajoutees :
            ...
            if noeudSelectionne not in listeNoeudsSelectionnes :
                ...
                print("Arête créée entre", i+3, " et " , int(noeudSelectionne))
                print("Avec une probabilité de : ", nombreAretesRajoutees/sommeDegres, "\n")
                k += 1
            else :
        ...
        print("La liste des noeuds selectionnés est : " , listeNoeudsSelectionnes, "\n")
